...
import { complete_todo, process_todo, recovery_todo, remove_todo, trash_remove } from "../../redux/action_types";

export default function Card_Trash(props) {
  const dispatch = useDispatch();

 
  const hadleDelete = () => {
  
    dispatch(trash_remove(props.id));
  };

  const handleRecovery = () => {

    dispatch(recovery_todo(props.id))
  }
  ...
  return (
    <div id={`card-${props.color}`}>
      ...
      <div class="author">
        ...
        <div id="div-button">
          <button>
            <span onClick={handleRecovery} class="material-symbols-outlined">note_add</span>
          </button>
